package cn.edu.zju.mypay.adapter;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewholder.iv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int count = ((CartActivity)context).getSelectedItemCountById(list.get(position).getProduct_id());
                ...
                ((CartActivity)context).handlerCarNum(1,list.get(position),true);
                catograyAdapter.notifyDataSetChanged();
                ...
                ((CartActivity)context).setAnim(ball, startLocation);// 开始执行动画
        ...
        viewholder.iv_remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((CartActivity)context).handlerCarNum(0,list.get(position),true);
                catograyAdapter.notifyDataSetChanged();
